...
class ArticlesTest(unittest.TestCase):
    ...
    def setUp(self):
        ...
        Set up method that will run before every Test
        '''
        self.new_article = Articles ('CNN','Amira Mugure','Centonomy should help Africa grow','A look at how centonomy can grow Africas blue economy','centonomy.com','centonomy.com/1245.jpeg','2018-11-14T10:57:16Z')
